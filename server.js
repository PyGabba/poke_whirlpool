...
const menu = {
  ...
  // ── Condimenti: personalizzazione dei secondi piatti, non voci vendibili da sole ──
  condimenti: [
    { id: 'cd1',  name: 'Sale e pepe' },
    { id: 'cd2',  name: 'Salsa chili' },
    { id: 'cd3',  name: 'Funghi e bambù' },
    { id: 'cd4',  name: 'Curry' },
    { id: 'cd5',  name: 'Agrodolce' },
    { id: 'cd6',  name: 'Satè' },
    { id: 'cd7',  name: 'Limone' },
    { id: 'cd8',  name: 'Mandorle' },
    { id: 'cd9',  name: 'Patate' },
    { id: 'cd10', name: 'Fritto' },
    { id: 'cd11', name: 'Griglia' },
  ],
  pokeTradizonali: [
